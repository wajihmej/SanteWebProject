...
$suiviC= new SuiviC();
$resultat=$suiviC->recupererSuiviUtilisateur(1);
?>
   ...
   <?php include'navbar.php'  ?>
        ...
        <section class="page-section" >
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Mes suivis</h2>
                <!-- Icon Divider-->
                ...
                <div>
                    <form method="POST" action="AjouterSuivi.php">
                  ...
                  <table class="table">
                    ...
                    <td> <?php echo $row['question5']; ?> </td>
                                            ...
                                            if($row['etat']==0)
                                            {
                                                ?>
                                            <td>
                                                <input type="submit" class="btn btn-warning" value= "Non Traiter">
                                            </td>
                                            <td>                               
                                                <form method="POST" action="ModifierSuivi.php?id=<?PHP echo $row['id']; ?>">
                                            ...
                                            <td>                               
                                                <form method="POST" action="SupprimerSuivi.php?id=<?PHP echo $row['id']; ?>">
                                            ...
                                            else
                                            {
                                                ?>
                                            <td>
                                                <form method="POST" action="AfficherSuivi.php?id=<?PHP echo $row['id']; ?>">
                                                <input type="submit" class="btn btn-success" value= "Traiter">
                                                </form>
                                            </td>
                                            <td>                               
                                            </td>
