...
if($_POST['Envoyer'])
{
$suivi=new Suivi($_POST['nom'],$_POST['prenom'],1,$question1,$question2,$question3,$question4,$question5,$_POST['reponse1'],$_POST['reponse2'],$_POST['reponse3'],$_POST['reponse4'],$_POST['reponse5'],"","","","","");
$suiviC->modifierSuiviUtilisateur($suivi,1,$id);
                    ...
                    <div class="col-lg-8 mx-auto">
                        ...
                        <form method="POST"  novalidate="novalidate" enctype="multipart/form-data" >
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>Reponse</label>
                                    <input class="form-control" name="reponse1" type="text" placeholder="Votre Reponse" value="<?PHP echo $reponse1 ?>" required=""/>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>Reponse</label>
                                    <input class="form-control" name="reponse2" type="text" placeholder="Votre Reponse" value="<?PHP echo $reponse2 ?>" required=""/>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>Reponse</label>
                                    <input class="form-control" name="reponse3" type="text" placeholder="Votre Reponse" value="<?PHP echo $reponse3 ?>" required=""/>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>Reponse</label>
                                    <input class="form-control" name="reponse4" type="text" placeholder="Votre Reponse" value="<?PHP echo $reponse4 ?>" required=""/>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="control-group">
                                <div class="form-group floating-label-form-group controls mb-0 pb-2">
                                    <label>Reponse</label>
                                    <input class="form-control" name="reponse5" type="text" placeholder="Votre Reponse" value="<?PHP echo $reponse5 ?>" required=""/>
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <br />
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-xl" value="Envoyer" name="Envoyer" >
                            </div>
                        </form>
                    </div>
                </div>
